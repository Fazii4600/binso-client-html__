						...
						<div class="row">
									...
									<div class="sidebar-widget service-sidebar-single">
										...
										<div class="sidebar-service-list">
											<ul>
												...
												<li class="current"><a href="service-details3.php"><i class="fas fa-angle-right"></i><span>Digital Marketing</span></a></li>
							...
							<div class="col-xl-8 col-lg-8">
								<div class="services-details__content">
									...
									<p>Effective marketing is not solely about enhancing visual appeal; it is also instrumental in expanding your customer base and elevating brand awareness.
										<br>
										At Softech, we boast a team of seasoned digital marketers who specialize in content creation, graphic design, and video marketing. They possess extensive experience across various social media platforms, including Instagram, Facebook, TikTok, and more.
										<br>
										Moreover, our team can assist you in establishing a budget for paid marketing, such as Google Ads, and craft compelling advertisements to maximize your marketing budget’s return on investment.</p>
										...
										<div class="feature-list mt-4">
											<div class="row clearfix">
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													...
													<p>The widespread adoption of an omni-channel communication strategy in both business-to-business and business-to-consumer settings is a direct result of the widespread availability and use of digital technologies. The success of your brand’s establishment and communication now relies on your choice of marketing techniques and how you plan to use them for your company’s growth.</p>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<img class="mb-3" src="images/resource/service-d2.jpg" alt="images" />
													<p>As experts in digital marketing technologies, we work closely with our clients’ agency ecosystems and marketing communication teams. Our knowledgeable staff can take your marketing and communication plan and implement the right technological solutions to bridge the gap between your business and its target audience.</p>
												</div>
											</div>
										</div>
									</div>
