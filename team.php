	...
	<section class="">
		<div class="container pb-90">
            <div class="carousel-outer">
                <div class="team-carousel-four owl-carousel owl-theme custom-navs-two">
                    
                    <div class="team-block-three">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="#" tabindex="0"><img src="images/resource/team3-1.jpg" alt=""></a></figure>
                                <div class="info-box">
                                    <h4 class="name"><a href="#" tabindex="0">Jessica Brown</a></h4>
                                    ...
                                    <div class="social-links">
                                        ...
                                        <a href="#" tabindex="0"><i class="fab fa-pinterest-p"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="team-block-three">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="#" tabindex="0"><img src="images/resource/team3-2.jpg" alt=""></a></figure>
                                <div class="info-box">
                                    <h4 class="name"><a href="#" tabindex="0">Kevin martin</a></h4>
                                    <span class="designation">Dog Trainer</span>
                                    <span class="icon fa fa-share-alt"></span>
                                    <div class="social-links">
                                        <a href="#" tabindex="0"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="team-block-three">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="#" tabindex="0"><img src="images/resource/team3-3.jpg" alt=""></a></figure>
                                <div class="info-box">
                                    <h4 class="name"><a href="#" tabindex="0">Aleesha brown</a></h4>
                                    <span class="designation">Dog Trainer</span>
                                    <span class="icon fa fa-share-alt"></span>
                                    <div class="social-links">
                                        <a href="#" tabindex="0"><i class="fab fa-facebook-f"></i></a>
