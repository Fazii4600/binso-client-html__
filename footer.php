        ...
        <div class="row">
          ...
          <div class="footer-column col-lg-3 col-sm-6">
            <div class="footer-widget contacts-widget">
              ...
              <div class="text">B 1053 Satellite Town Rawalpindi</div>
              <ul class="contact-info">
                <li><i class="fa fa-envelope"></i> <a href="mailto:info@softech.team ">info@softech.team </a><br/></li>
                <li><i class="fa fa-phone-square"></i> <a href="tel:+92 51 8745519 ">+92 51 8745519 </a><br/></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="footer-bottom">
      <div class="auto-container">
        <div class="inner-container">
          <div class="copyright-text">&copy; Copyright 2024 by  <a href="index.php">Softech.team</a></div>
        </div>
      </div>
    </div>
  </footer>