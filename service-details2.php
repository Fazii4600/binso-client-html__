				...
				<section class="page-title" style="background-image: url(images/background/page-title.jpg);">
					<div class="auto-container">
						<div class="title-outer">
							<h1 class="title">E-Commerce Solutions</h1>
						...
						<div class="row">
									...
									<div class="sidebar-widget service-sidebar-single">
										...
										<div class="sidebar-service-list">
											<ul>
												...
												<li class="current" ><a href="service-details2.php"><i class="fas fa-angle-right"></i><span>E-Commerce Solutions</span></a></li>
							...
							<div class="col-xl-8 col-lg-8">
								<div class="services-details__content">
									...
									<p>At Softech UK, we offer end-to-end eCommerce solutions that are tailored to meet the diverse needs of your online business. From creating and optimizing online stores using platforms like Shopify, eCommerce, or OpenCart, to expanding your reach on major marketplaces such as eBay and Amazon, we’ve got you covered. Our expertise extends to Google Merchant services, ensuring your products reach a wider audience, while our payment gateway consultancy ensures seamless and secure transactions. 
										<br>
										But our commitment doesn’t stop there. We understand that in today’s digital landscape, visibility is key. That’s why our dedicated team also specializes in Search Engine Optimization (SEO), helping your eCommerce store rank higher in search results and attract more organic traffic. Whether you’re just starting or looking to enhance your existing eCommerce presence, Softech UK’s comprehensive eCommerce solutions provide the foundation for your online success.</p>
									
									
										<div class="feature-list mt-4">
											<div class="row clearfix">
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<img class="mb-3" src="images/resource/database.jpg" alt="images" />
													<p>As experts in bespoke web development, we have the expertise to design Content Management Systems (CMS) and Database Management Systems (DBMS) for storing and organising your data and files. Softech UK offers professional content management system creation services, helping businesses and individuals establish and maintain efficient and organised systems for managing their website’s content and data.</p>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<img class="mb-3" src="images/resource/service-d2.jpg" alt="images" />
													<p>If you’re looking for a reliable CMS development firm, go as far as us. Our skilled CMS development team will allow you to continue running your business as usual while significantly increasing your flexibility. Our unrivalled CMS development solutions will meet and surpass your expectations, thanks to our years of expertise as a professional CMS web development services supplier.</p>
												</div>
											</div>
										</div>
									</div>
