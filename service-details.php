						...
						<div class="row">
									...
									<div class="sidebar-widget service-sidebar-single">
										...
										<div class="service-details-help">
											...
											<div class="help-contact">
												...
												<a href="tel:12463330079">+92 51 8745519 </a>
											</div>
										</div>
							...
							<div class="col-xl-8 col-lg-8">
								<div class="services-details__content">
									<img src="images/resource/web-development.jpg" alt="" />
									<h3 class="mt-4">Service Overview</h3>
									<p>From the very beginning, the internet has served as the cornerstone of digital transformation. Elevate your growth trajectory with our wealth of expertise in web engineering. 
										<br>
										As one of the leading web application development firms in the UK, our web developers boast extensive experience in crafting web applications across a diverse spectrum of web frameworks, programming languages, and protocols. We offer a comprehensive solution for all your web development needs.
										<br>
										Whether your objective is to create a tailored web-based product, introduce a new application, or establish an online store, our accomplished web development team possesses the capability to turn your vision into reality.</p>
									
									
										<div class="feature-list mt-4">
											<div class="row clearfix">
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<img class="mb-3" src="images/resource/target-audience.jpg" alt="images" />
													<p>SoftechUK understands the critical importance of your website not only looking fantastic but also functioning seamlessly to enhance your company’s online reputation. We specialize in providing custom web development services tailored to your business’s specific needs. Our skilled team of developers can design a user-friendly, mobile-responsive, and visually appealing website that represents your brand and captivates your target audience. With a customized website showcasing your business’s identity and attracting your intended audience, let us assist you in succeeding in the modern world.</p>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<img class="mb-3" src="images/resource/service-d2.jpg" alt="images" />
													<p>As one of the leading web application development firms in the UK, our web developers boast extensive experience in crafting web applications across a diverse spectrum of web frameworks, programming languages, and protocols. We offer a comprehensive solution for all your web development needs.</p>
												</div>
											</div>
										</div>
									</div>
